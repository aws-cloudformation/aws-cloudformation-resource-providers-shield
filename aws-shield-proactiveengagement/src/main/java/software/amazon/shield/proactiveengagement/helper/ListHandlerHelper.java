...
public class ListHandlerHelper extends HandlerHelper {
        ...
        try (ShieldClient shieldClient = proxyClient.client()) {
            return proxy.initiate("shield::describe-emergency-contact", proxyClient, model, context)
                    ...
                    .done((r) -> {
                        ...
                        model.setEmergencyContactList(ListHandlerHelper.convertSDKEmergencyContactList(r.emergencyContactList()));
