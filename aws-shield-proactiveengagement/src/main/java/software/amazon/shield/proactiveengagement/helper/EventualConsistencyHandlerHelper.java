...
public class EventualConsistencyHandlerHelper<M, C extends EventualConsistencyCallbackContext> {
    public static final int EVENTUAL_CONSISTENCY_DELAY_SECONDS = 1;

    /**
     * Perform the final propagation delay to make sure the latest version of the resource is available throughout the
     * region.
     */
    public ProgressEvent<M, C> waitForChangesToPropagate(ProgressEvent<M, C> progressEvent) {
